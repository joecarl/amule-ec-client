// EC Protocol constants and enumerations
...
export enum ECTagName {
	...
	EC_TAG_STATS_TOTAL_SENT_BYTES = 0x0217,
	EC_TAG_STATS_TOTAL_RECEIVED_BYTES = 0x0218,
	EC_TAG_STATS_SHARED_FILE_COUNT = 0x0219,
	EC_TAG_STATS_LOGGER_MESSAGE = 0x021a,
...
export enum ECSearchFileDownloadStatus {
	NEW = 0,
	DOWNLOADED = 1,
	QUEUED = 2,
	CANCELED = 3,
...
export enum ECStatTreeNodeValueType {
